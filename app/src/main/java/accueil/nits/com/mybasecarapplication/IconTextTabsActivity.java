...
public class IconTextTabsActivity extends AppCompatActivity {
    ...
    private int[] tabIcons = {
            R.drawable.ic_local_gas_station_24dp,
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new OneFragment(), "Conso");
        adapter.addFrag(new TwoFragment(), "Service");
        adapter.addFrag(new ThreeFragment(), "Rappel");
